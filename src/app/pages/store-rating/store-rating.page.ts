...
@Component({
  ...
  templateUrl: './store-rating.page.html',
  styleUrls: ['./store-rating.page.scss'],
})
export class StoreRatingPage implements OnInit {
  id: any;
  name: any;
  rate: any = 2;
  comment: any = '';
  ...
  constructor(
    ...
    this.util.show();
    this.api.post_private('v1/ratings/getByStoreId', param).then((data: any) => {
      this.util.hide();
